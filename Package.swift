...
let package = Package(
  ...
  targets: [
    ...
    .target(
      ...
      path: "libmdbx",
      exclude: [
        "libmdbx/build/CMakeFiles",
        "libmdbx/build/CMakeScripts",
        "libmdbx/build/CMakeCache.txt",
        "libmdbx/build/cmake_install.cmake",
        "libmdbx/build/test",
        "libmdbx/include",
        "libmdbx/test",
        "libmdbx/packages",
      ...
      cSettings: [
        ...
        .headerSearchPath("./libmdbx/build"),
        .define("__APPLE__"),
