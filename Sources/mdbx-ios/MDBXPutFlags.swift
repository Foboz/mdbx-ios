...
struct MDBXPutFlags: OptionSet {
  ...
  static let upsert = MDBXDatabaseFlags(rawValue: libmdbx_ios.MDBX_UPSERT.rawValue)

  /** For insertion: Don't write if the key already exists. */
  static let noOverWrite = MDBXDatabaseFlags(rawValue: libmdbx_ios.MDBX_NOOVERWRITE.rawValue)
  ...
  static let noDupData = MDBXDatabaseFlags(rawValue: libmdbx_ios.MDBX_NODUPDATA.rawValue)
  ...
  static let current = MDBXDatabaseFlags(rawValue: libmdbx_ios.MDBX_CURRENT.rawValue)
  ...
  static let allDups = MDBXDatabaseFlags(rawValue: libmdbx_ios.MDBX_ALLDUPS.rawValue)
  
  /** For upsertion: Just reserve space for data, don't copy it.
   * Return a pointer to the reserved space. */
  static let reserve = MDBXDatabaseFlags(rawValue: libmdbx_ios.MDBX_RESERVE.rawValue)

  /** Data is being appended.
   * Don't split full pages, continue on a new instead. */
  static let append = MDBXDatabaseFlags(rawValue: libmdbx_ios.MDBX_APPEND.rawValue)
  
  /** Has effect only for \ref MDBX_DUPSORT databases.
   * Duplicate data is being appended.
   * Don't split full pages, continue on a new instead. */
  static let appendDup = MDBXDatabaseFlags(rawValue: libmdbx_ios.MDBX_APPENDDUP.rawValue)
  
  /** Only for \ref MDBX_DUPFIXED.
   * Store multiple data items in one call. */
  static let multiple = MDBXDatabaseFlags(rawValue: libmdbx_ios.MDBX_MULTIPLE.rawValue)
}
