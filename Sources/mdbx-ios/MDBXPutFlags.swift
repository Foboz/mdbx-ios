...
public struct MDBXPutFlags: OptionSet {
  ...
  public static let upsert = MDBXPutFlags(rawValue: libmdbx_ios.MDBX_UPSERT.rawValue)

  /** For insertion: Don't write if the key already exists. */
  public static let noOverWrite = MDBXPutFlags(rawValue: libmdbx_ios.MDBX_NOOVERWRITE.rawValue)
  ...
  public static let noDupData = MDBXPutFlags(rawValue: libmdbx_ios.MDBX_NODUPDATA.rawValue)
  ...
  public static let current = MDBXPutFlags(rawValue: libmdbx_ios.MDBX_CURRENT.rawValue)
  ...
  public static let allDups = MDBXPutFlags(rawValue: libmdbx_ios.MDBX_ALLDUPS.rawValue)
  
  /** For upsertion: Just reserve space for data, don't copy it.
   * Return a pointer to the reserved space. */
  public static let reserve = MDBXPutFlags(rawValue: libmdbx_ios.MDBX_RESERVE.rawValue)

  /** Data is being appended.
   * Don't split full pages, continue on a new instead. */
  public static let append = MDBXPutFlags(rawValue: libmdbx_ios.MDBX_APPEND.rawValue)
  
  /** Has effect only for \ref MDBX_DUPSORT databases.
   * Duplicate data is being appended.
   * Don't split full pages, continue on a new instead. */
  public static let appendDup = MDBXPutFlags(rawValue: libmdbx_ios.MDBX_APPENDDUP.rawValue)
  
  /** Only for \ref MDBX_DUPFIXED.
   * Store multiple data items in one call. */
  public static let multiple = MDBXPutFlags(rawValue: libmdbx_ios.MDBX_MULTIPLE.rawValue)
}
